...
export const SingleCatPage = () => {
  ...
  const OverlayTwo = () => (
    <ModalOverlay backdropInvert="50%" backdropBlur="30px" />
  );
  ...
  const singleData = () => {
    axios
      .get(`https://cute-erin-tick-hat.cyclic.cloud/cats/get/${id}`)
      .then((res) => {
          ...
          <div>
            ...
            <div style={{ marginTop: "30px" }}>
              <Text fontSize="lg" fontWeight="bold">
                Color:{" "}
                <span style={{ fontWeight: "normal" }}>{page.color}</span>
              </Text>
              <Text
                fontSize="lg"
                fontWeight="bold"
              ...
              >
                Size: <span style={{ fontWeight: "normal" }}>{page.size}</span>
              </Text>
            </div>
            <h4 mt={2}>Price: {page.adoption_fee}/-</h4>
            <br />
