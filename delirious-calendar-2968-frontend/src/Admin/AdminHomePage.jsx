...
export const AdminHomePage = () => {
  ...
  let getUserData = () => {
    axios
      .get("https://cute-erin-tick-hat.cyclic.cloud/admin/users")
      .then((res) => {
  ...
  let getPostData = () => {
    axios
      .get("https://cute-erin-tick-hat.cyclic.cloud/admin/forms")
      .then((res) => {
  ...
  let handleBlockUSer = (id) => {
    axios
      .post(`https://cute-erin-tick-hat.cyclic.cloud/admin/block/${id}`)
      .then((res) => {
        getUserData();
        toast({
  ...
  let getDogsData = () => {
    axios
      .get(
        `https://cute-erin-tick-hat.cyclic.cloud/dogs/get?page=${currentPage}&limit=10`
      )
      .then((res) => {
  ...
  let getCatsData = () => {
    axios
      .get(
        `https://cute-erin-tick-hat.cyclic.cloud/cats/get?page=${page}&limit=10`
      )
      .then((res) => {
  ...
  const DeleteDogsData = (id) => {
    axios
      .delete(`https://cute-erin-tick-hat.cyclic.cloud/dogs/delete/${id}`)
      .then((res) => {
        toast({
          title: "Data Deleted",
          status: "error",
  ...
  const DeleteCatsData = (id) => {
    axios
      .delete(`https://cute-erin-tick-hat.cyclic.cloud/Cats/delete/${id}`)
      .then((res) => {
        toast({
          title: "Data Deleted",
          status: "error",
  ...
  let handleReject = (id) => {
    axios
      .delete(`https://cute-erin-tick-hat.cyclic.cloud/post/delete/${id}`)
      .then((res) => {
        toast({
  ...
  let handleApprove = (id) => {
    axios
      .patch(`https://cute-erin-tick-hat.cyclic.cloud/post/patch/${id}`)
      .then((res) => {
        toast({
    ...
    <div style={{ backgroundColor: "#ffffff", paddingTop: "70px" }}>
      <Flex alignItems={"center"} height="100px" bg="#dccbd5">
        <Flex justifyContent={"space-around"} w="80%">
          <Button
            _hover={{ borderRadius: "25px", bg: "#e3e8e6" }}
            borderRadius={"none"}
            outline={"none"}
            bg="#dccbd5"
