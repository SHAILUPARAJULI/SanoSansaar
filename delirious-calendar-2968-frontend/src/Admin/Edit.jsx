...
export const EditContribution = () => {
    ...
    useEffect(() => {
        const fetchPetData = async () => {
            try {
                ...
                const response = await axios.get(`https://cute-erin-tick-hat.cyclic.cloud/${petType}/get/${petId}`,
    ...
    const handleUpdate = async () => {
        try {
            ...
            const response = await axios.patch(`https://cute-erin-tick-hat.cyclic.cloud/${petType}/patch/${petId}`, petData);
            toast({
    ...
    return (
        <div className="edit-contribution-form-container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button style={{ marginTop: "30px" }} className="Button" type="submit">Update {petType === 'cats' ? 'Cat' : 'Dog'}</button>
            </form>
        </div>
    );
};
